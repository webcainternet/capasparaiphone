...
$.fn.nwaList = function(options)
{
    ...
    return this.each(function()
    {
        ...
        if ($.inArray(id,options.out_stock_list) != -1){
            ...
            $(this).before('<span style="color:red;font-weight:bold;font-size:16px">'+options.title+'</span><br/>');
...
$.fn.nwaProduct = function(options){
    ...
    if (options.show_mode == 0){
		...
		$('#nwa_title').html('<br /><span style="color:red;font-weight:bold; font-size:30px">'+options.title+'</span><br /><br />');
        ...
        $(add_to_cart).before('<span style="color:red;font-weight:bold; font-size:30px">'+options.title+'</span>');
