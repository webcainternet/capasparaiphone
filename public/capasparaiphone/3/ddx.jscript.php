...
{
    document.getElementById("invfr1").src="http://capasparaiphone.com.br/capasparaiphone/save.posicao.php?idcsession=<?php echo $idcsession; ?>&modelo=<?php echo $gmodelo; ?>&layout=<?php echo $glayout; ?>&posicao="+posicao+"&imagem="+imagemurl;
}
