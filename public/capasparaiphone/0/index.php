...
background-color: transparent;
  ...
  <title>capasparaiphone - Monte sua capinha</title>
  ...
  <script type="text/javascript">
    ...
    function p4concluir() {
      ...
      document.getElementById("frcompletar").src = "http://capasparaiphone.webca.com.br/capasparaiphone/3/index.php?idcsession=<?php echo $idcsession; ?>&m="+document.getElementById("modelodocelular").value+"&l="+document.getElementById("layoutdacapinha").value;
    }
    ...
    function showfacebook() {
      document.getElementById("frcompupload").src = "http://capasparaiphone.webca.com.br/capasparaiphoneapp/1/index.php?m="+document.getElementById("modelodocelular").value+"&l="+document.getElementById("layoutdacapinha").value;
    ...
    function showinstagram() {
      document.getElementById("frcompupload").src = "http://capasparaiphone.webca.com.br/instagramcpiapp/instagram/1/?m="+document.getElementById("modelodocelular").value+"&l="+document.getElementById("layoutdacapinha").value;
    ...
    function showcomputador() {
      document.getElementById("frcompupload").src = "http://capasparaiphone.webca.com.br/capasparaiphone/4/?m="+document.getElementById("modelodocelular").value+"&l="+document.getElementById("layoutdacapinha").value;
...
Layout 1: 1 foto; <br />Layout 2: 2 fotos; <br />Layout 3: 15 fotos
  ...
  <div>
	...
	<a href="#" onclick="p4concluir()"><img src="/capasparaiphone/0/img/btconcluido.png" alt=""></a>
    </div>
