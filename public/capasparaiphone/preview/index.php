                ...
                if (!$result1) { 
                        ...
                        ?>
                                <div id="divl2a" ondrop="dropl2(event, '1')" ondragover="allowDrop(event)" style="float: left;  width: <?php echo $mw2; ?>px; height: <?php echo $mh2; ?>px; overflow: hidden;text-align: center; align: middle;">
                                    <img src="<?php echo $imagemurl[1]; ?>" id="imgl2a" draggable="true" ondragstart="drag(event)" style="max-width: 5000%; max-height: 5000%; margin-top: <?php echo $ntop[1]; ?>px; margin-left: <?php echo $nleft[1]; ?>px;" width="<?php echo $nwidth[1]; ?>" height="<?php echo $nheight[1]; ?>">
                                </div>
                        <?php
                        }
                }
...
<!--
      ...
      <div style="float: left; text-align: left; width: 95px; margin-bottom: 20px; margin-left: 15px;">
        ...
        <div style="background-color: #303030; position: fixed; top: 10px; right: 10px; padding: 20px; border-radius: 15px; color: #FFFFFF;">
...
<?php if ($_GET["m"] == "0") { ?>
<div id="mascarasp" style="position: absolute; top: 0px; left: 0px; padding: 0px; height: 980px; width: 680px; background-size: 680px; background-image: url(http://www.capasparaiphone.com.br/capasparaiphone/0/img/mask-iphone4-b.png); background-repeat: no-repeat no-repeat;">&nbsp;</div>
<? } ?>

<?php if ($_GET["m"] == "1") { ?>
<div id="mascarasp" style="position: absolute; top: 0px; left: 0px; padding: 0px; height: 1076px; width: 680px; background-size: 680px; background-image: url(http://www.capasparaiphone.com.br/capasparaiphone/0/img/mask-iphone5-b.png); background-repeat: no-repeat no-repeat;">&nbsp;</div>
<? } ?>

<?php if ($_GET["m"] == "2") { ?>
<div id="mascarasp" style="position: absolute; top: 0px; left: 0px; padding: 0px; height: 1054px; width: 680px; background-size: 680px; background-image: url(http://www.capasparaiphone.com.br/capasparaiphone/0/img/mask-galaxy3-b.png); background-repeat: no-repeat no-repeat;">&nbsp;</div>
<? } ?>

<?php if ($_GET["m"] == "3") { ?>
<div id="mascarasp" style="position: absolute; top: 0px; left: 0px; padding: 0px; height: 998px; width: 680px; background-size: 680px; background-image: url(http://www.capasparaiphone.com.br/capasparaiphone/0/img/mask-galaxy4-b.png); background-repeat: no-repeat no-repeat;">&nbsp;</div>
<? } ?>

<?php if ($_GET["m"] == "4") { ?>
<div id="mascarasp" style="position: absolute; top: 0px; left: 0px; padding: 0px; height: 1116px; width: 680px; background-size: 680px; background-image: url(http://www.capasparaiphone.com.br/capasparaiphone/0/img/mask-galaxy4-b.png); background-repeat: no-repeat no-repeat;">&nbsp;</div>
<? } ?>
