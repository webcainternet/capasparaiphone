        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <table class="option-image">
			...
			<?php } ?>
             ...
             value="<?php echo $option_value['product_option_value_id']; ?>" id="option-value-<?php echo $option_value['product_option_value_id']; ?>" /></td>
        ...
        <div id="option-<?php echo $option['product_option_id']; ?>" class="option">
          ...
          <textarea  
			...
			<?php } ?>
             ...
             cols="40" rows="5" style="width:210px"><?php echo $option['option_value']; ?></textarea>
          </div>
        </div>
        <?php } ?>
