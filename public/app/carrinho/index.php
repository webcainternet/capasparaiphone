...
<?php
	...
	$larguraunitaria = $larguraunitaria/4;
...
<?php //Layout 1 Foto
	...
	if (!$result1) { 
		...
		while ($row1 = mysql_fetch_array($result1, MYSQL_ASSOC)) { 
			...
			$nheight[1] 	= $row1["nheight"]/4;
			$nwidth[1] 		= $row1["nwidth"]/4;
			$nleft[1] 		= $row1["nleft"]/4;
			$ntop[1] 		= $row1["ntop"]/4;
		}
	} ?>
...
<?php //Layout 2 Foto
	...
	if (!$result2) { 
            ...
            $nheight[2]     = $row2["nheight"]/4;
            $nwidth[2]      = $row2["nwidth"]/4;
            $nleft[2]       = $row2["nleft"]/4;
            $ntop[2]        = $row2["ntop"]/4;
    	}
	}
?>
...
<?php //Layout 6 Foto
	...
	if (!$result3) { 
            ...
            $nheight[3]     = $row3["nheight"]/4;
            $nwidth[3]      = $row3["nwidth"]/4;
            $nleft[3]       = $row3["nleft"]/4;
            $ntop[3]        = $row3["ntop"]/4;
    	}
	}
	...
	if (!$result4) { 
            ...
            $nheight[4]     = $row4["nheight"]/4;
            $nwidth[4]      = $row4["nwidth"]/4;
            $nleft[4]       = $row4["nleft"]/4;
            $ntop[4]        = $row4["ntop"]/4;
    	}
	}
	...
	if (!$result5) { 
            ...
            $nheight[5]     = $row5["nheight"]/4;
            $nwidth[5]      = $row5["nwidth"]/4;
            $nleft[5]       = $row5["nleft"]/4;
            $ntop[5]        = $row5["ntop"]/4;
    	}
	}
	...
	if (!$result6) { 
            ...
            $nheight[6]     = $row6["nheight"]/4;
            $nwidth[6]      = $row6["nwidth"]/4;
            $nleft[6]       = $row6["nleft"]/4;
            $ntop[6]        = $row6["ntop"]/4;
    	}
	}
?>
...
<?php //Layout 8 Foto
	...
	if (!$result7) { 
            ...
            $nheight[7]     = $row7["nheight"]/4;
            $nwidth[7]      = $row7["nwidth"]/4;
            $nleft[7]       = $row7["nleft"]/4;
            $ntop[7]        = $row7["ntop"]/4;
    	}
	}
	...
	if (!$result8) { 
            ...
            $nheight[8]     = $row8["nheight"]/4;
            $nwidth[8]      = $row8["nwidth"]/4;
            $nleft[8]       = $row8["nleft"]/4;
            $ntop[8]        = $row8["ntop"]/4;
    	}
	}
?>
...
<?php } ?>
<!-- Mascaras -->
<div style="position: absolute; top: 0px; left: 0px; margin-left: 0px; padding: 0px; height: 142px; width: 82px; background-size: 82px; background-image: url(https://www.capasparaiphone.com.br/app/img/mask-<?php echo $_GET["m"]; ?>.png); background-repeat: no-repeat no-repeat;">&nbsp;</div>
