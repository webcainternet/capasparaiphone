...
<script type="text/javascript" src="/catalog/view/theme/dilecta/fancybox/lib/jquery-1.10.1.min.js"></script>
	...
	if ($glayout == 0) {
		...
		if (!$result1) { 
			...
			?>
                  ...
                  <div style="display: block; float: left; width: 87px; border-left-style: solid; border-left-width: 0px; border-left-color: rgb(204, 204, 204); height: 135px; text-align: center; background-position: 15px 10px; background-repeat: no-repeat no-repeat;">
                  <!-- ddx.layout -->
        ...
        $sqlangulo1 = "SELECT * FROM cpi_capasconstrucao_girar WHERE idsession = $gidcsession AND posicao = 1 limit 1;";
...
<!-- FIM LAYOUT 2 -->
                ...
                $sqlangulo2 = "SELECT * FROM cpi_capasconstrucao_girar WHERE idsession = $gidcsession AND posicao = 2 limit 1;";
        ...
        if ($glayout == 2) {
                ...
                $sql_statement9  = "SELECT * FROM cpi_capasconstrucao WHERE idcsession = $gidcsession AND modelo = $gmodelo AND layout = $glayout AND posicao = 9  order by datainsert desc limit 1";
                ...
                $sql_statement10  = "SELECT * FROM cpi_capasconstrucao WHERE idcsession = $gidcsession AND modelo = $gmodelo AND layout = $glayout AND posicao = 10  order by datainsert desc limit 1";
                ...
                if (!$result10) { 
                        ...
                        while ($row10 = mysql_fetch_array($result10, MYSQL_ASSOC)) { 
                                ...
                                $nheight[10]     = $nheight[10]/4;
                                $nwidth[10]      = $nwidth[10]/4;
                                $nleft[10]       = $nleft[10]/4;
                                $ntop[10]        = $ntop[10]/4;
                        ?>
                                <script>
                ...
                $sql_statement11  = "SELECT * FROM cpi_capasconstrucao WHERE idcsession = $gidcsession AND modelo = $gmodelo AND layout = $glayout AND posicao = 11  order by datainsert desc limit 1";
                ...
                if (!$result11) { 
                        ...
                        while ($row11 = mysql_fetch_array($result11, MYSQL_ASSOC)) { 
                                ...
                                $nheight[11]     = $nheight[11]/4;
                                $nwidth[11]      = $nwidth[11]/4;
                                $nleft[11]       = $nleft[11]/4;
                                $ntop[11]        = $ntop[11]/4;
                        ?>
                                <script>
                ...
                $sql_statement12  = "SELECT * FROM cpi_capasconstrucao WHERE idcsession = $gidcsession AND modelo = $gmodelo AND layout = $glayout AND posicao = 12  order by datainsert desc limit 1";
                ...
                if (!$result12) { 
                        ...
                        while ($row12 = mysql_fetch_array($result12, MYSQL_ASSOC)) { 
                                ...
                                $nheight[12]     = $nheight[12]/4;
                                $nwidth[12]      = $nwidth[12]/4;
                                $nleft[12]       = $nleft[12]/4;
                                $ntop[12]        = $ntop[12]/4;
                        ?>
                                <script>
                ...
                $sql_statement13  = "SELECT * FROM cpi_capasconstrucao WHERE idcsession = $gidcsession AND modelo = $gmodelo AND layout = $glayout AND posicao = 13  order by datainsert desc limit 1";
                ...
                if (!$result13) { 
                        ...
                        while ($row13 = mysql_fetch_array($result13, MYSQL_ASSOC)) { 
                                ...
                                $nheight[13]     = $nheight[13]/4;
                                $nwidth[13]      = $nwidth[13]/4;
                                $nleft[13]       = $nleft[13]/4;
                                $ntop[13]        = $ntop[13]/4;
                        ?>
                                <script>
                ...
                $sql_statement14  = "SELECT * FROM cpi_capasconstrucao WHERE idcsession = $gidcsession AND modelo = $gmodelo AND layout = $glayout AND posicao = 14  order by datainsert desc limit 1";
                ...
                if (!$result14) { 
                        ...
                        while ($row14 = mysql_fetch_array($result14, MYSQL_ASSOC)) { 
                                ...
                                $nheight[14]     = $nheight[14]/4;
                                $nwidth[14]      = $nwidth[14]/4;
                                $nleft[14]       = $nleft[14]/4;
                                $ntop[14]        = $ntop[14]/4;
                        ?>
                                <script>
                ...
                $sql_statement15  = "SELECT * FROM cpi_capasconstrucao WHERE idcsession = $gidcsession AND modelo = $gmodelo AND layout = $glayout AND posicao = 15  order by datainsert desc limit 1";
                ...
                if (!$result15) { 
                        ...
                        while ($row15 = mysql_fetch_array($result15, MYSQL_ASSOC)) { 
                                ...
                                $nheight[15]     = $nheight[15]/4;
                                $nwidth[15]      = $nwidth[15]/4;
                                $nleft[15]       = $nleft[15]/4;
                                $ntop[15]        = $ntop[15]/4;
                        ?>
                                <script>
...
<?php if ($_GET["m"] == "0") { ?>
<div id="mascarasp" style="position: absolute; top: 0px; left: 0px; padding: 0px; height: 122px; width: 85px; background-size: 85px; background-image: url(http://www.capasparaiphone.com.br/app/img/mask-iphone4-top.png); background-repeat: no-repeat no-repeat;">&nbsp;</div>
<? } ?>

<?php if ($_GET["m"] == "1") { ?>
<div id="mascarasp" style="position: absolute; top: 0px; left: 0px; padding: 0px; height: 134px; width: 85px; background-size: 85px; background-image: url(http://www.capasparaiphone.com.br/app/img/mask-iphone5-top.png); background-repeat: no-repeat no-repeat;">&nbsp;</div>
<? } ?>

<?php if ($_GET["m"] == "2") { ?>
<div id="mascarasp" style="position: absolute; top: 0px; left: 0px; padding: 0px; height: 131px; width: 85px; background-size: 85px; background-image: url(http://www.capasparaiphone.com.br/app/img/mask-galaxy3-top.png); background-repeat: no-repeat no-repeat;">&nbsp;</div>
<? } ?>

<?php if ($_GET["m"] == "3") { ?>
<div id="mascarasp" style="position: absolute; top: 0px; left: 0px; padding: 0px; height: 124px; width: 85px; background-size: 85px; background-image: url(http://www.capasparaiphone.com.br/app/img/mask-galaxy4-top.png); background-repeat: no-repeat no-repeat;">&nbsp;</div>
<? } ?>

<?php if ($_GET["m"] == "4") { ?>
<div style="position: absolute; top: 0px; left: 0px; margin-left: 0px; padding: 0px; height: 139px; width: 85px; background-size: 85px; background-image: url(http://www.capasparaiphone.com.br/app/img/mask-galaxys2-top.png);">&nbsp;</div>
<? } ?>

<?php if ($_GET["m"] == "5") { ?>
<div style="position: absolute; top: 0px; left: 0px; margin-left: 0px; padding: 0px; height: 139px; width: 85px; background-size: 85px; background-image: url(http://www.capasparaiphone.com.br/app/img/mask-galaxyn2-top.png);">&nbsp;</div>
<? } ?>
