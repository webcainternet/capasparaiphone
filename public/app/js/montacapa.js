function GirarImg(idsession, posicao, angulo) {
   $(document).ready(function(){
      var response = '';
      $.ajax({ type: "GET",
               url: "http://www.capasparaiphone.com.br/app/save.girar.php?idsession="+idsession+"&posicao="+posicao+"&angulo="+angulo,
               async: false,
...
function MontaCapa(modelo, layout) {
   $(document).ready(function(){
      var response = '';
      $.ajax({ type: "GET",
               url: "http://www.capasparaiphone.com.br/app/capinha/?m="+modelo+"&l="+layout,
               async: false,
               success : function(text)
               {
                   response = text;
...
{
    document.getElementById("invfr"+posicao).src="http://www.capasparaiphone.com.br/app/update.posicao.php?idcsession="+idsession+"&posicao="+posicao+"&imagem="+imagemurl+"&nheight="+nheight+"&nwidth="+nwidth+"&nleft="+nleft+"&ntop="+ntop;
}
