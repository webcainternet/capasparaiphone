...
<!-- Mascaras -->
<?php if ($_GET["m"] == "0") { ?>
<div style="position: absolute; top: 0px; left: 0px; margin-left: 10px; padding: 0px; height: 494px; width: 340px; background-size: 340px; background-image: url(http://localhost/app/img/mask-iphone4-top.png); background-repeat: no-repeat no-repeat;">&nbsp;</div>
<? } ?>

<?php if ($_GET["m"] == "1") { ?>
<div style="position: absolute; top: 0px; left: 0px; margin-left: 10px; padding: 0px; height: 542px; width: 340px; background-size: 340px; background-image: url(http://localhost/app/img/mask-iphone5-top.png); background-repeat: no-repeat no-repeat;">&nbsp;</div>
<? } ?>

<?php if ($_GET["m"] == "2") { ?>
<div style="position: absolute; top: 0px; left: 0px; margin-left: 10px; padding: 0px; height: 531px; width: 340px; background-size: 340px; background-image: url(http://localhost/app/img/mask-galaxy3-top.png); background-repeat: no-repeat no-repeat;">&nbsp;</div>
<? } ?>

<?php if ($_GET["m"] == "3") { ?>
<div style="position: absolute; top: 0px; left: 0px; margin-left: 10px; padding: 0px; height: 503px; width: 340px; background-size: 340px; background-image: url(http://localhost/app/img/mask-galaxy4-top.png); background-repeat: no-repeat no-repeat;">&nbsp;</div>
<? } ?>

<?php if ($_GET["m"] == "4") { ?>
<div style="position: absolute; top: 0px; left: 0px; margin-left: 10px; padding: 0px; height: 563px; width: 343px; background-size: 340px; background-image: url(http://localhost/app/img/mask-galaxys2-top.png);">&nbsp;</div>
<? } ?>

<?php if ($_GET["m"] == "5") { ?>
<div style="position: absolute; top: 0px; left: 0px; margin-left: 10px; padding: 0px; height: 564px; width: 343px; background-size: 340px; background-image: url(http://localhost/app/img/mask-galaxyn2-top.png);">&nbsp;</div>
<? } ?>
