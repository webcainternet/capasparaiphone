...
.fonte_personalizada2 { 
  font-family: "Minha Fonte2", Arial, Verdana;
  font-size: 14px;
  color: #6aa11a;
}
body, p {
font-family: "Minha Fonte2", Arial, Verdana;
  ...
  <script type="text/javascript">
    ...
    function showfacebook() {
      window.parent.document.getElementById("frcompupload").src = "http://capasparaiphone.webca.com.br/capasparaiphoneapp/1/?m="+document.getElementById("modelodocelular").value+"&l="+document.getElementById("layoutdacapinha").value;
    ...
    function showcomputador() {
      window.parent.document.getElementById("frcompupload").src = "http://capasparaiphone.webca.com.br/capasparaiphone/1/?m="+document.getElementById("modelodocelular").value+"&l="+document.getElementById("layoutdacapinha").value;
...
Layout 1: 1 foto; Layout 2: 2 fotos; Layout 3: 15 fotos
</div>
  ...
  <div>
    <div id="imagensselecione" style="float: left; width: 348px;">
      <p>
        ...
        <input onChange="showfacebook()" type="radio" name="modelo" id="ishowinst" value="" style="display: inline; float: none;position: relative; top: -50px;">
