...
$_['text_checkout_shipping_address'] = 'Passo 2: Detalhes da entrega';
$_['text_checkout_shipping_method']  = 'Passo 3: Forma de entrega';
$_['text_checkout_payment_method']   = 'Passo 4: Forma de pagamento';
$_['text_checkout_confirm']          = 'Passo 5: Confirmar pedido';
$_['text_modify']                    = 'Editar &raquo;';
$_['text_new_customer']              = 'Novo cliente';
$_['text_returning_customer']        = 'Já sou cliente';
$_['text_checkout']                  = 'Opções de finalização de compra:';
$_['text_i_am_returning_customer']   = 'Já sou cliente';
$_['text_register']                  = 'Cadastrar-se (recomendado)';
$_['text_guest']                     = 'Finalizar sem se cadastrar';
$_['text_register_account']          = 'Ao cadastrar-se e criar uma conta você poderá comprar mais rapidamente, saber a situação do pedido e acompanhar as compras já realizadas.';
...
$_['text_agree']                     = 'Li e concordo com <a class="colorbox" href="%s" alt="%s"><b>%s</b></a>';
$_['text_address_new']               = 'Quero usar um novo endereço';
//$_['text_address_existing']          = 'Quero usar um endereço já cadastrado';
$_['text_address_existing']          = 'Escolha abaixo o endereço de entrega da sua compra:';
$_['text_shipping_method']           = 'Selecione a forma de entrega de sua preferência para esta compra.';
$_['text_payment_method']            = 'Selecione a forma de pagamento de sua preferência para esta compra.';
...
// Error
$_['error_warning']                  = 'Houve um problema ao tentar processar o seu pedido! Se o problema persistir, tente selecionar outro método de pagamento, ou <a href="%s">entre em contato</a>.';
$_['error_minimum']                  = 'Quantidade mínima para %s é %s!';	
$_['error_login']                    = 'Aviso: Nenhum resultado para endereço de email e/ou senha.';
$_['error_approved']                 = 'Aviso: Sua conta precisa ser aprovada antes que possa fazer o login.';
$_['error_exists']                   = 'Aviso: Este e-mail já está registrado!';
...
$_['error_company_id']               = 'O ID da empresa é obrigatório!';
$_['error_tax_id']                   = 'O ID da taxa é obrigatório!';
$_['error_vat']                      = 'O número de VAT é inválido!';
...
$_['error_agree']                    = 'Aviso: Você deve aderir aos %s!';
$_['error_address']                  = 'Aviso: Você deve selecionar um endereço!';
$_['error_shipping']                 = 'Aviso: Escolha uma forma de entrega!';
$_['error_no_shipping']              = 'Aviso: Não há opções de envio disponíveis. Por favor <a href="%s">contate-nos</a> para assistência!';
$_['error_payment']                  = 'Aviso: Escolha uma forma de pagamento!';
