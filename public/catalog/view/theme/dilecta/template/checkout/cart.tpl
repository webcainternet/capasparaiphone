...
<?php $grid = 12; if($column_left != '') { $grid = $grid-3; } if($column_right != '') { $grid = $grid-3; } ?>
  ...
  <h2 style="border:none;padding-bottom:0px;margin-bottom:20px"><?php echo $text_next; ?></h2>
  ...
  <div class="cart-module">
    <div id="coupon" class="content" style="display: <?php echo ($next == 'coupon' ? 'block' : 'none'); ?>;">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
        ...
        &nbsp;
        <input type="submit" value="<?php echo $button_coupon; ?>" class="button button-two" />
      </form>
    </div>
    <div id="voucher" class="content" style="display: <?php echo ($next == 'voucher' ? 'block' : 'none'); ?>;">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
        ...
        &nbsp;
        <input type="submit" value="<?php echo $button_voucher; ?>" class="button button-two" />
      </form>
    </div>
    <div id="reward" class="content" style="display: <?php echo ($next == 'reward' ? 'block' : 'none'); ?>;">
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
        ...
        &nbsp;
        <input type="submit" value="<?php echo $button_reward; ?>" class="button button-two" />
      </form>
    </div>
    <div id="shipping" class="content" style="display:block; ?>;">
      ...
      <input type="button" value="<?php echo $button_quote; ?>" id="button-quote" class="button button-two" />
    </div>
  </div>
  <?php } ?>
  ...
  <div class="buttons">
    ...
    <div class="center"><a href="<?php echo $continue; ?>" class="button button-two"><?php echo $button_shopping; ?></a></div>
  </div>
				...
				for (i in json['shipping_method']) {
					...
					if (!json['shipping_method'][i]['error']) {
						for (j in json['shipping_method'][i]['quote']) {
							...
							if (json['shipping_method'][i]['quote'][j]['code'] == "correios.41068"){
