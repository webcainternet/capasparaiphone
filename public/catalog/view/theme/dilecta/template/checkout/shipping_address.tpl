<?php if ($addresses) { ?>
<input type="radio" name="shipping_address" value="existing" id="shipping-address-existing" checked="checked" style="visibility:hidden;" />
<label for="shipping-address-existing" style="margin-left:-26px;"><?php echo $text_address_existing; ?></label>
...
<p>
  ...
  <a href="index.php?route=account/address/insert">Para cadastrar um endere&ccedil;o de entrega diferente, <b>clique aqui</b></a>
</p>
<?php } ?>
