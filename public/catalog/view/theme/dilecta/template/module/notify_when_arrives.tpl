...
<img src="image/data/titulo-aviseme.png" border="0" />
<br/>
                <?php echo $text_description; ?><br/><br/>
                <?php if ($nwa_use_name){?>
                <span class="help" style="font-size:13px; color:#000000"><?php echo $nwa_entry_name; ?></span> 
                <input type="text"    name="notify_name"   value="<?php echo $notify_name; ?>"    id="nwa_name" style="width:75%;margin: 3px;" /><br/>               
                <?php }?>
                <?php if ($nwa_use_phone){?>
                 <span class="help" style="font-size:13px; color:#000000"><?php echo $nwa_entry_phone; ?></span> 
                <input type="text"    name="notify_phone"    value="<?php echo $notify_phone; ?>"   id="nwa_phone" style="width:75%;margin: 3px;" /><br/>
                <?php }?>   
                <?php if ($nwa_use_custom){?>
                 <span class="help" style="font-size:13px; color:#000000"><?php echo $nwa_entry_custom; ?></span> 
                <input type="text"    name="notify_custom"      id="nwa_custom" style="width:75%;margin: 3px;" /><br/>
                <?php }?> 
                 <?php if ($nwa_entry_mail){?>
                 <span class="help" style="font-size:13px; color:#000000"><?php echo $nwa_entry_mail; ?></span> 
                 <?php }?> 
...
<br/><br/>
                ...
                <div  id="nwa_msg" style="float:none;padding-bottom: 5px; margin-top:10px; font-size:13px"></div>
            </div>
        </div>
    </div>
