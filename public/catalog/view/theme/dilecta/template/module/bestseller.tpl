<?php $id_module = rand(1,999); ?>
		...
		<section id="bestseller_<?php echo $id_module; ?>" class="box">
			
			<!-- Title -->
			
			<h2 class="box-title"><?php echo $heading_title; ?></h2>
			
		  		<?php if(!($this->config->get('product_scroll_bestsellers') == '0' && $this->config->get('general_status') == '1')) { ?>
				<!-- Pagination -->
				
				<div class="pagination-product clearfix">
				
					<a href="#" class="prev-products" id="module_bestseller_<?php echo $id_module; ?>_prev"></a>
					<a href="#" class="next-products" id="module_bestseller_<?php echo $id_module; ?>_next"></a>
				
				</div>
								
				<script type="text/javascript">
					jQuery(function($){
						paginacja('module_bestseller_<?php echo $id_module; ?>');
					});
				</script>
				<?php } ?> 
				...
				<div class="overflow-products clearfix" id="module_bestseller_<?php echo $id_module; ?>">
