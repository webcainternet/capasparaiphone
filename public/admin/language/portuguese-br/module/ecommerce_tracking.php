...
// Heading
$_['heading_title']       = 'Ecommerce Tracking';

// Text
$_['text_module']         = 'Modules';
$_['text_success']        = 'Success: You have modified module ecommerce tracking!';
$_['text_product_id']     = 'Product ID';
$_['text_sku']            = 'SKU';

// Entry
$_['entry_sku']           = 'Field to use for SKU:';
$_['entry_status']        = 'Status:';

// Error
$_['error_permission']    = 'Warning: You do not have permission to modify module ecommerce tracking!';
?>